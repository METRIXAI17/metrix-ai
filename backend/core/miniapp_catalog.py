...
FLAGSHIPS = [
    ...
    },
    {
        ...
        "accent": "#fb7185",
        "sku": "access_month",
        "essence_ru": "R — мера исхода. Плечо — размер. Движок их не путает.",
        "cta": "chain",
        "flagship": True,
    },
    {
        ...
        "accent": "#67e8f9",
        "sku": "custom_teammate",
        "essence_ru": "Unit Desk, Onboard Geometry, Cohort Step, Order Cycle. Воркфлоу нового решения.",
        "cta": "teammates",
        "flagship": True,
    },
    {
        "id": "artefact_panel",
        "section": "artefacts",
        "title_ru": "Аналитическая панель",
        "title_en": "Analytical panel",
        "sticker": "Panel",
        "accent": "#c4b5fd",
        "sku": "access_month",
        "essence_ru": "Метрики как артефакт. Конструкторы пустоты. Не дашборд-обои.",
        "cta": "artefacts",
        "flagship": True,
    },
    {
        "id": "offer_gen",
        "section": "artefacts",
        "title_ru": "Генератор предложений",
        "title_en": "Offer generator",
        "sticker": "Offer",
        "accent": "#fbbf24",
        "sku": "access_month",
        "essence_ru": "Неделя + оффер с kill. Бывший мейкинг и промо — одна папка.",
        "cta": "artefacts",
        "flagship": True,
    },
]
