...
ASK_ACCESS = (
    ...
    "Не входит: Metrix AI $2490 (ecom физ. товаров), Custom $500.\n"
...
ASK_MONTH_CAP = (
    ...
    "Новый месяц — снова 40 карт. Metrix AI $2490 — ecom физических товаров, не этот бот."
)
...
HELP = (
    ...
    "Код согласованной модели, не сигналы. Metrix AI $2490 — ecom физ. товаров."
)
