...
ASK_ACCESS = (
    ...
    "Metrix Access — 3 290 ₽ / месяц. Одна подписка на Chain, Teammates и Artefacts. "
    "Код модели, обновления как есть. Не сигналы.\n"
    "Не входит: Main $2490 без пилота, Custom $500, Tape Land.\n"
